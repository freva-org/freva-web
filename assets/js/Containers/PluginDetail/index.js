    ...
    return (
      <Container>
        <Row>
          ...
          <Col md={12}>
            <ButtonToolbar>
              <Button variant="success" className="me-2" href={`/plugins/${plugin.name.toLowerCase()}/setup/`}>Start
                analysis</Button>
              <Button variant="primary" className="me-2" href={`/history/?plugin=${plugin.name.toLowerCase()}`}>Show
                history</Button>
              {
                plugin.docpage ?
                  <Button variant="primary" className="me-2" href={plugin.docpage}>Documentation</Button> : null
              }
              {
